...
const Gallery = () => {
  ...
  const allImages = useMemo(
    () => [
      ...
      { id: 5, src: "/showcase/21.avif", width: 800, height: 600, alt: "Gallery image 5" },
      { id: 6, src: "/showcase/23.avif", width: 600, height: 900, alt: "Gallery image 6" },
      { id: 7, src: "/showcase/24.avif", width: 800, height: 600, alt: "Gallery image 7" },
      { id: 8, src: "/showcase/25.avif", width: 600, height: 900, alt: "Gallery image 8" },
      { id: 9, src: "/showcase/15.avif", width: 800, height: 600, alt: "Gallery image 9" },
      { id: 10, src: "/showcase/12.avif", width: 600, height: 800, alt: "Gallery image 10" },
      { id: 11, src: "/showcase/13.avif", width: 800, height: 600, alt: "Gallery image 11" },
      { id: 12, src: "/showcase/16.avif", width: 600, height: 900, alt: "Gallery image 12" },
    ],
    []
  );
